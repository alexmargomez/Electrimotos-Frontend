...
import Electrimotos from "../assets/electrimotos.png"; // Importamos la imagen de Electrimotos
function LoginScreen() {
  return (
    <div className=" h-screen w-full bg-[#023047]">
      <main className="flex justify-center items-center h-19/20 w-full">
        <div className="w-1/2 h-full flex flex-col items-center justify-center ">
          <div className="relative w-3/4 h-3/4 bg-white flex flex-col items-center justify-center shadow-xl rounded-lg">
            ...
            <h1 className=" font-semibold mb-4 text-center text-5xl">
              Iniciar sesión
            </h1>
      ...
      <footer className="h-1/20">
        <p className="text-white text-center">
          © 2025 Alexmar Gómez Software. Todos los derechos reservados. |
          Plataforma de facturación POS - FACTUPOS.
        </p>
      </footer>
    </div>
  );
