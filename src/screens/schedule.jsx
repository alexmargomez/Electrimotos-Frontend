...
const Schedule = () => {
  ...
  const [clientOptions, setClientOptions] = useState({
    name: ["Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez", "Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez","Juan Pérez", "María Gómez", "Carlos Rodríguez"],
    cc: ["12345678", "87654321", "45678912"],
    phone: ["3001234567", "3019876543", "3105678901"],
  ...
  const [vehicleOptions, setVehicleOptions] = useState({  
    plate: ["ABC123", "DEF456", "GHI789"],
    make: ["Chevrolet", "Renault", "Mazda"],
    model: ["Aveo", "Logan", "CX-5"]
  });
              ...
              <div className='h-3/4 pl-10 pr-10 flex flex-col justify-center items-center pb-5'>
                {Object.keys(clientValues).map((field, index) => (
                  <div key={index} className='relative w-full'>
                    ...
                    />
                    <datalist id={field} >
                      {clientOptions[field].map((option, idx) => (
              ...
              <div className='h-3/4 pl-10 pr-10 flex flex-col justify-center items-center pb-5'>
                {Object.keys(vehicleValues).map((field, index) => (
                  <div key={index} className='relative w-full'>
                    ...
                    />
                    <datalist id={field} >
                      {vehicleOptions[field].map((option, idx) => (
                        <option key={idx} value={option} />
                      ))}
                    </datalist>
                  </div>
