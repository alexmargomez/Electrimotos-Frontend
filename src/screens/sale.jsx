  ...
  return (
    <div className='h-screen w-full flex flex-col bg-gray-200'>
      ...
      <div className="p-5 m-4 h-full bg-white rounded-sm shadow-xl mt-0 border-t-3 border-[#FFD700] flex flex-wrap">
        ...
        <section className='h-3/11 w-full flex shadow-2xl'> {/* datos de factura */}
        ...
        <section className='flex justify-center items-center w-full h-7/11 space-x-2 shadow-2xl'> {/*Busqueda de producto o servicio y factura*/}
          <div className='w-1/2 h-full border-2 border-[#494A8A] rounded-sm'> {/*Busqueda de producto o servicio*/}
            <div className='flex h-1/10  space-x-10 bg-[#494A8A] '> {/*Barra de busqueda*/}
              <div 
                className={' px-4 py-2 cursor-pointer w-1/2 flex justify-end items-center'} 
              ...
              <div
                className={'px-4 py-2 cursor-pointer w-1/2 flex justify-between items-center'} 
                onClick={() => handleTabClick('servicio')}
              >
                <h2 className='text-white text-2xl'>Servicio</h2>
              </div>
            ...
            <div className='p-4 h-9/10 w-full '> {/*Contenido de producto o servicio*/}
              {activeTab === 'producto' ? (
                <div className='flex flex-col space-y-2 w-full h-full'>
                  <div className='flex justify-center items-center h-1/7 w-full bg-amber-600'>
                    Buscar producto
                  </div>
                  <div className='flex justify-center items-center h-6/7 w-full bg-amber-200'>
                    Lista de productos
                  </div>
                </div>
